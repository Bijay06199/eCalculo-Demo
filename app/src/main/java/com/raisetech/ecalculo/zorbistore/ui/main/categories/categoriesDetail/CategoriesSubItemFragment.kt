...
import com.raisetech.ecalculo.databinding.FragmentCategoriesSubItemBinding
...
class CategoriesSubItemFragment : BaseFragment<FragmentCategoriesSubItemBinding,CategoriesSubItemViewModel>(),
...
MultiImageAdapter.OnItemClickListener{
    ...
    companion object {
        fun start(activity: FragmentActivity, containerId: Int, id: Int?) {
            var fragment = CategoriesSubItemFragment()
            var bundle = Bundle()
    ...
    override fun getLayoutId(): Int =R.layout.fragment_categories_sub_item

    override fun getViewModel(): CategoriesSubItemViewModel=categoriesSubItemViewModel
    private val categoriesSubItemViewModel:CategoriesSubItemViewModel by viewModel()
    ...
    private fun setUpRecyclerView() {
        with(viewDataBinding){
            with(categoriesSubItemViewModel){

                var itemList=ArrayList<Data>()
                productAdapter= ProductAdapter(requireContext(), this@CategoriesSubItemFragment, itemList)
    ...
    override fun onItemSelect(position: Int, itemList: Data) {
        ...
        with(viewDataBinding){
            ...
            for (i in 0..position){
                ...
                multiImageAdapter= MultiImageAdapter(this@CategoriesSubItemFragment,
